<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-primary text-primary-foreground shadow-[0_0_15px_rgba(255,42,122,0.4)] hover:shadow-[0_0_20px_rgba(255,42,122,0.8)] [a]:hover:bg-primary/80 transition-shadow",
